...
public class Main extends Application {
    public static void main(String[] args) {
        ...
        // ###### CONSOLE APP ########
        // to use CONSOLE APP un-comment this line (line 20 )
        StartingRestaurant r1 = new StartingRestaurant();

        // ###### GUI APP ########
        // to use GUI APP make sure that line 20 is commented
        Application.launch();
    ...
    public void start(Stage stage) throws Exception {
        ...
        foodComboBox.setOnAction(event -> {
            ...
            double   price = m1.getItemPrice(Menu.getItemId(foodComboBox.getValue()));
            pricefild.setText( price + " EGP");
        ...
        Menu m1 = new Menu("Menu 1");
        foodCountfild.textProperty().addListener( e -> {
            double   price = m1.getItemPrice(Menu.getItemId(foodComboBox.getValue()));
            price =  price * Integer.parseInt(foodCountfild.getText()) ;
            pricefild.setText( price + " EGP");
